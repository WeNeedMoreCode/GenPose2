 ...
 * Uses same 5-parameter signature as v3 debug kernel to ensure binary compatibility.
 * Only actually uses the debug parameter — others are dummy.
 */
...
extern "C" __global__ __aicore__ void fps_custom_minimal_test(
